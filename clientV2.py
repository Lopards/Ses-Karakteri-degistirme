...
class Client:
    ...
    def create_interface(self):
        ...
        self.read_text_button = tk.Button(frame_alt, text="metini oku",command=self.read_text, state="disabled")
    ...
    def read_text(self):
        ...
        # Ses dosyasını oluşturun ve çalın
        tts.save("ses.mp3")
